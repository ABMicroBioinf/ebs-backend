# Generated by Django 2.2.22 on 2021-08-17 21:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RawStats_Reads', models.IntegerField(blank=True, null=True)),
                ('RawStats_Yield', models.IntegerField(blank=True, null=True)),
                ('RawStats_GeeCee', models.FloatField(blank=True, null=True)),
                ('RawStats_MinLen', models.IntegerField(blank=True, null=True)),
                ('RawStats_AvgLen', models.IntegerField(blank=True, null=True)),
                ('RawStats_MaxLen', models.IntegerField(blank=True, null=True)),
                ('RawStats_AvgQual', models.FloatField(blank=True, null=True)),
                ('RawStats_ErrQual', models.FloatField(blank=True, null=True)),
                ('RawStats_Ambiguous', models.FloatField(blank=True, null=True)),
                ('QcStats_Reads', models.IntegerField(blank=True, null=True)),
                ('QcStats_Yield', models.IntegerField(blank=True, null=True)),
                ('QcStats_GeeCee', models.FloatField(blank=True, null=True)),
                ('QcStats_MinLen', models.IntegerField(blank=True, null=True)),
                ('QcStats_AvgLen', models.IntegerField(blank=True, null=True)),
                ('QcStats_MaxLen', models.IntegerField(blank=True, null=True)),
                ('QcStats_AvgQual', models.FloatField(blank=True, null=True)),
                ('QcStats_ErrQual', models.FloatField(blank=True, null=True)),
                ('QcStats_Ambiguous', models.FloatField(blank=True, null=True)),
