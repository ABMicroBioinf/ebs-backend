...
class Experiment(models.Model):
    ...
    librarySource = models.CharField(max_length=100, choices=common.seq_exp_sources, null=True, blank=True) # metagenomics
    libraryLayout = models.CharField(max_length=100, choices=common.seq_exp_layouts, null=True, blank=True) # paired
    librarySelection = models.CharField(max_length=100, choices=common.seq_exp_selections, null=True, blank=True) #random
    description = models.CharField(max_length=100, null=True, blank=True)
